...
import { Eye, EyeOff, Loader2, Sparkles, Shield, Zap, Users, Star, ArrowRight } from 'lucide-react';
          ...
          <div className="relative z-10 h-full flex flex-col justify-between">
            <div>
              ...
              <p className="text-lg text-white/80 mb-8">
                Unlock the power of AI-driven analytics to transform your data into actionable insights.
              </p>
            </div>
            <div className="flex items-center gap-6">
              ...
              <div>
                <p className="text-white font-medium">Trusted by 10,000+ teams</p>
                <p className="text-white/70 text-sm">Including industry leaders</p>
              </div>
            </div>
          </div>
        </motion.div>
          ...
          <div className="w-full max-w-md mx-auto">
            ...
            <div className="mb-8 lg:hidden">
              ...
              <p className="text-sm text-gray-500 dark:text-gray-400">
                Sign in to continue building smarter insights
              </p>
            </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full rounded-xl border border-gray-300 dark:border-gray-700 bg-gray-50/50 dark:bg-gray-800/50 px-4 py-3 pr-12 text-gray-900 dark:text-white placeholder:text-gray-400 dark:placeholder:text-gray-500 transition-all duration-200 focus:border-primary-500 focus:outline-none focus:ring-4 focus:ring-primary-500/10 dark:focus:ring-primary-400/10 focus:bg-white dark:focus:bg-gray-800"
